  ...
  return (
    <>
      ...
      <button
        ...
        className={`lg:hidden fixed top-4 left-4 z-50 bg-indigo-600 dark:bg-gray-800 text-white p-2 rounded-lg shadow-lg transition-opacity duration-200 ${isOpen ? "opacity-0 pointer-events-none" : "opacity-100"}`}
      >
        <Menu size={22} />
      </button>
